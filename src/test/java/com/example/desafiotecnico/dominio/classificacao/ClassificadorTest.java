...
public class ClassificadorTest {
    ...
    public void deve_obter_lista_de_criterios() {
        ...
        assertThat(criteriosRetornados).element(2).isInstanceOf(CriterioQuantidadeDeDependentes.class);
        assertThat(criteriosRetornados).element(3).isInstanceOf(CriterioQuantidadeDeDependentes.class);
    }
}
